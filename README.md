*Looking for the original app template? Go here --> [sveltejs/template](https://github.com/sveltejs/template)*
...
```console
npx degit HeRoMo/svelte3-ts-pug-sass-template#main svelte-app
cd svelte-app
```
